...
char* update_time_temp_humd_alarm(); // Update time, temperature, humidity and check alarms every loop
...
char* check_temp_humd(void); // Check the temperature and humidity and ring an alarm if needed
